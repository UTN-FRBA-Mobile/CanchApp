...
public class CanchaHeader implements Serializable {
    ...
    public CanchaHeader(String nombre, TipoCancha tipoCancha, TipoSuperficie superficie, Boolean techada, String fotoUrl) {
        this.nombre = nombre;
